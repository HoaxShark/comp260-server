class Player:
    ...
    def __init__(self, dungeon, start_room):
        self.current_room = start_room  # Room the player is currently in
        self.dungeon_ref = dungeon  # The entire dungeon
        self.player_id = 0  # Identification tag of the player
        self.current_weight = 0  # The current weight of everything the player has
        self.max_weight = 100  # Maximum weight the player can reach before being unable to move
